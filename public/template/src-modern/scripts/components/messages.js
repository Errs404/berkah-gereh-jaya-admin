...
document.addEventListener("alpine:init", () => {
    Alpine.data("messagesComponent", () => ({
            ...
            this.conversations = [
                {
                    ...
                    messages: [
                        ...
                        {
                            id: 15,
                            text: "You too! Thanks again for the excellent distributor service.",
                            time: "10:55 AM",
                            sent: false,
                        },
                    ],
        ...
        newConversation() {
            this.showNotification(
                "New conversation modal would open here",
                "info"
            );
        },
        ...
        simulateActivity() {
            ...
            setInterval(() => {
                if (Math.random() > 0.8) {
                    ...
                    randomConv.unread += 1;
                    randomConv.lastMessage =
                        newMessages[
                            Math.floor(Math.random() * newMessages.length)
                        ];
