                    ...
                    <div x-data="reportsComponent" x-init="init()">
                            ...
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" x-model="reportType" @change="updateReportType()">
                                        ...
                                        <option value="distributors">Distributor Insights</option>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <div class="metric-value" x-text="kpis.distributors.toLocaleString()"></div>
                                            <div class="metric-change positive">
                                                <i class="bi bi-arrow-up"></i>
                                                <span x-text="`+${kpis.distributorsChange}%`"></span> vs last period
                                            </div>
                                        </div>
                        ...
                        <div class="row g-4 g-lg-5 mb-5">
                            ...
                            <div class="col-lg-6">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Distributor Acquisition</h5>
                                    </div>
                                    <div class="card-body p-3 p-lg-4">
                                        <div id="distributorAcquisitionChart" style="height: 250px;"></div>
                                    </div>
                                </div>
                            </div>
